...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
        <path d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12zm-.441-14.8L8.223 7.455c.28-.405.595-.774.946-1.097a5.326 5.326 0 0 1 1.328-.82 5.503 5.503 0 0 1 1.584-.405 5.11 5.11 0 0 1 1.714.09c.559.134 1.082.351 1.554.64.472.29.89.645 1.251 1.067.361.422.656.896.882 1.421.226.526.373 1.085.441 1.677.068.592.056 1.187-.036 1.783a5.412 5.412 0 0 1-.513 1.677 5.597 5.597 0 0 1-.914 1.421 5.054 5.054 0 0 1-1.267 1.067c-.482.29-1.01.507-1.574.64a5.139 5.139 0 0 1-1.714.09 5.532 5.532 0 0 1-1.584-.405 5.326 5.326 0 0 1-1.328-.82c-.351-.323-.666-.692-.946-1.097l3.336-1.745c.149.216.328.405.533.567.205.162.431.284.677.365.246.081.502.122.769.122.267 0 .523-.04.769-.122.246-.081.472-.203.677-.365.205-.162.384-.351.533-.567.149-.216.262-.452.339-.708.077-.256.115-.522.115-.798 0-.276-.038-.542-.115-.798a2.093 2.093 0 0 0-.339-.708z"/>
      </svg>
    ),
  },
];
