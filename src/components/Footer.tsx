...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
        <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-.5 4.9c-.5.3-1 .8-1.4 1.4-.3.5-.6 1.1-.8 1.7-.6 1.8-.6 3.8.1 5.6.3.9.8 1.7 1.5 2.4.5.5 1.1.8 1.8 1 .4.1.8.1 1.2.1.8-.1 1.6-.3 2.3-.8.5-.3 1-.8 1.4-1.4.3-.5.6-1.1.8-1.7.6-1.8.6-3.8-.1-5.6-.3-.9-.8-1.7-1.5-2.4-.5-.5-1.1-.8-1.8-1-.4-.1-.8-.1-1.2-.1-.8.1-1.6.3-2.3.8zm1 2.1c.2-.1.4-.1.6 0 .5.2.9.7 1.1 1.2.2.7.2 1.4 0 2.1-.1.4-.3.8-.6 1.1-.2.2-.4.3-.7.3-.2 0-.4-.1-.6-.2-.5-.2-.9-.7-1.1-1.2-.2-.7-.2-1.4 0-2.1.1-.4.3-.8.6-1.1.2-.1.4-.2.7-.1z"/>
      </svg>
    ),
  },
];
